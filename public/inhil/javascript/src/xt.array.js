...
/**
 Adding addiotional array functions
 copyright: http://4umi.com/web/javascript/array.php
**/
...
Array.prototype.remove=function(v){if(this.indexOf(v)>-1){return this.splice(this.indexOf(v),1);}}
Array.prototype.unique=function(){var a=[],i;this.sort();for(i=0;i<this.length;i++){if(this[i]!==this[i+1]){a[a.length]=this[i];}}return a;}
Array.prototype.addunique=function(v){if(this.indexOf(v)<0){this[this.length]=v;}return this.length;}
Array.prototype.pushunique=function(){for(var i=0,j=0,b=this.length,a=arguments;i<a.length;i++,j++){if(this.indexOf(a[i])<0){this[b+j]=a[i];}else{j--}}return this.length;}
